...
public class TC_13_Update_user_by_accessExpiryDt extends base {
	...
	public void updateUser() {
		...
		accexp = jsonPath.get("[3].accessExpiryDt");
		...
		requestParams1.put("accessExpiryDt","02-10-2020");
	...
	@Test
	public void TC__13_Update_user_by_accessExpiryDt() {
		String responseBody = response.getBody().asString();
		System.out.println("res"+responseBody);
		//System.out.println("RESULT="+object);
		test.log(LogStatus.INFO, "Before update accessExpiryDt==> "+accexp);
		Assert.assertEquals(responseBody.contains("INTERNAL_SERVER_ERROR"), true);		
		//Assert.assertEquals(responseBody.contains(contactPhone), true);
		test.log(LogStatus.INFO, "Response Body is==> "+responseBody);
		test.log(LogStatus.INFO, "After update accessExpiryDt==> "+"02-10-2020");
