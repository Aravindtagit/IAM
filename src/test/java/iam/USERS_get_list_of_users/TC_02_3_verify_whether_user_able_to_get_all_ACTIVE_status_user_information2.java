...
public class TC_02_3_verify_whether_user_able_to_get_all_ACTIVE_status_user_information2 extends base {
	...
	@Test
	public void TC__02_03_verify_whether_user_able_to_get_all_ACTIVE_user_information2() {
		String responseBody = response.getBody().asString();
		System.out.println("res"+responseBody);
		
	
		//Assert.assertEquals(responseBody.contains("createdBy:ADMIN"), true);		
