...
public class TC_4_verify_whether_user_able_to_get_all_INACTIVE_status_all_user_information extends base {
	...
	@Test
	public void TC__4_verify_whether_user_able_to_get_all_INACTIVE_all_user_information() {
		String responseBody = response.getBody().asString();
		System.out.println("res"+responseBody);
		
	
		Assert.assertEquals(responseBody.contains("INACTIVE"), true);		
