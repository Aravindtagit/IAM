...
public class TC_29__create_user_with_username_field_as_maximum_51_characters extends base {
	String userId1 = RestUtil.userId();
	String username1 = RestUtil.username();
	...
	public void createUser() throws InterruptedException {
		...
		requestParams.put("userName", username1);
	...
	@Test
	public void TC_29_create_user_with_username_field_as_maximum_characters() {
		...
		Assert.assertEquals(responseBody.contains(username1), true);
