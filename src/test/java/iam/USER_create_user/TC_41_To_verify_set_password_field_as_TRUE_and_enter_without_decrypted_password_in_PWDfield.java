...
public class TC_41_To_verify_set_password_field_as_TRUE_and_enter_without_decrypted_password_in_PWDfield extends base {
	...
	public void createUser() throws InterruptedException {
		...
		requestParams.put("setPasswordLater", "true");
		requestParams.put("pswd", "123");
		header();
		Thread.sleep(1000);
	...
	@Test
	public void TC_41_To__verify_set_password_field_as_TRUE_and_enter_without_decrypted_password_in_PWDfield() {
		...
		Assert.assertEquals(responseBody.contains("DECRYPTION_OPERATION_NOT_POSSIBLE_EXCEPTION"), true);
