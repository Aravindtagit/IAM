...
public class TC_71_user_able_to_create_MAKER_CHECKER_without_userID3 extends base {
	...
	public void createUser() throws InterruptedException {
		...
		requestParams.put("userType", "MAKER_CHECKER");
	...
	@Test
	public void TC__71_user_able_to_create_MAKER_CHECKER_without_userID3() {
		...
		//\\test.log(LogStatus.INFO, "Response Body is==> "+responseBody);
