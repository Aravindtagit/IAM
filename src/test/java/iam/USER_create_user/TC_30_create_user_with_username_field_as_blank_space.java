...
public class TC_30_create_user_with_username_field_as_blank_space extends base {
	...
	@Test
	public void TC__30_create_user_with_username_field_as_blank_space() {
		...
		Assert.assertEquals(responseBody.contains("USER_NAME_MANDATORY_100_CHAR"), true);
