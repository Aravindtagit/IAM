...
public class TC_04_Validate_userata_with_already_delted_userdata extends base {
	...
	public void validateUser() {
		...
		requestParams1.put("flag", "09");
		requestParams1.put("statusChangeDate", stschangedate);
		requestParams1.put("version","00");
		requestParams1.put("userKey","111JU");
		...
		requestParams1.put("userId", "145");
		requestParams1.put("userName", "TAGIT");
