...
public class TC_02_Validate_user_with_INvalid_userdata extends base {
	...
	public void validateUser() {
		...
		requestParams1.put("flag", "10");
		requestParams1.put("statusChangeDate", stschangedate);
		requestParams1.put("version","001");
		requestParams1.put("userKey","HU99");
		...
		requestParams1.put("userId", "TAGIT!@#$%^");
		requestParams1.put("userName", "TAGIT879898");
	...
	@Test
	public void TC_02__Validate_user_with_INvalid_userdata() {
