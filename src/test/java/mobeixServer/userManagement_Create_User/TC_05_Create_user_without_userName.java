...
public class TC_05_Create_user_without_userName extends base{
	...
	@Test
	public void TC_05__Create_user_without_userName() {
		String responseBody = response.getBody().asString();
		Assert.assertTrue(responseBody.contains("userName length must not null"));
