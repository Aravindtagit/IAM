...
public class TC_10_Update_userMobileNo_as_16_Char extends base {
	...
	public void createMerchant() {
		...
		requestParams.put("userMobileNo", RandomStringUtils.randomNumeric(16));
		header();
	...
	@Test
	public void TC_10__Update_userMobileNo_as_16_Char() {
		String responseBody = response.getBody().asString();
		Assert.assertEquals(responseBody.contains("userMobileNo length must not"), true);
